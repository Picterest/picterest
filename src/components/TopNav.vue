<template lang="html">
  <div class="px-3 py-4 flex items-center justify-between w-full">
    <div class="flex items-center">
      ...
      <button
        class="rounded-full py-3 px-4 font-semibold text-black bg-light hover:bg-dark hover:text-white"
        type="button"
        name="button"
        @click="this.$router.push('home')"
      >
    ...
    <div class="flex items-center">
      ...
      <div class="relative inline-block">
        <button
          type="button"
          name="button"
          class="w-6 h-6 hover:bg-light rounded-full flex items-center justify-center"
